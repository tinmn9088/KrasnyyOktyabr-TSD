...
// Процедура воспроизводит звуковой сигнал об успешном выполнении.
Процедура ВоспроизвестиЗвуковоеОповещениеОбУспешномВыполнении() Экспорт

    СредстваМультимедиа.ВоспроизвестиЗвуковоеОповещение("success", Истина);
