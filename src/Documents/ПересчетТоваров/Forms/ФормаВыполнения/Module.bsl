...
Асинх Процедура ОчиститьШтрихкодыАсинх(Команда)
    ...
    Ответ = Ждать ВопросАсинх("Будет очищен прогресс пересчета товаров.", РежимДиалогаВопрос.ДаНет, , КодВозвратаДиалога.Да, "Начать заново?"); // КодВозвратаДиалога
    ...
    ПоказатьОповещение("Штрихкоды очищены", Строка(ШтрихкодовУдалено));
