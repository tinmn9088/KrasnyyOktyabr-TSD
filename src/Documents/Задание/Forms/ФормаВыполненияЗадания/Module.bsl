...
Процедура ОбработатьШтрихкод(Штрихкод)
    ...
    ИначеЕсли ЭтоКодВозвратаНеНайденоЗаданиеНаОтборПоШтрихкоду(ОписаниеОбработкиШтрихкода.КодВозврата) Тогда
        ...
        ПоказатьВажноеОповещениеОшибка(ОписаниеОбработкиШтрихкода.КодВозврата, "Задание на отбор не найдено", Штрихкод);
    ...
    ИначеЕсли ЭтоКодВозвратаСлишкомМногоВКоробе(ОписаниеОбработкиШтрихкода.КодВозврата) Тогда
        ...
        ПоказатьВажноеОповещениеОшибка(ОписаниеОбработкиШтрихкода.КодВозврата,
...
//  Пояснение - Строка
&НаКлиенте
Процедура ПоказатьВажноеОповещениеОшибка(Знач КодВозврата, Знач Заголовок, Знач Пояснение)
