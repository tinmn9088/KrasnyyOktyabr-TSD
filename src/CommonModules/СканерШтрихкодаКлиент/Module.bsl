...
// Процедура настраивает драйвер для сканера штрихкода и добавляет его в
// коллекцию ВнешниеКомпоненты.
// 
// Параметры:
//  ВнешниеКомпоненты - См. ВнешниеКомпонентыКлиент.НоваяКоллекцияВнешнихКомпонент
...
// 
// Параметры:
//  ОписаниеВнешнегоСобытия - См. ВнешниеКомпонентыКлиент.НовоеОписаниеВнешнегоСобытия
...
// 
// Параметры:
//  МестоположениеВнешнейКомпоненты - Строка - Местоположение внешней компоненты, откуда она была установлена
...
// Процедура создает объект драйвера, устанавливает параметры и подключает его. Если при
