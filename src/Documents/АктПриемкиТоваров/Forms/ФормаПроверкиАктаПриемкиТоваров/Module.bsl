...
Процедура ОбработатьШтрихкод(Штрихкод)
    ...
    // 3.4. Оповещение о том, что количество принятого меньше количества поставленного
    ИначеЕсли ЭтоКодВозвратаКоличествоПоставленногоМеньшеПринятого(ОписаниеОбработкиШтрихкода.КодВозврата) Тогда

        ПояснениеОповещения = СтрШаблон("Номенклатура %1", ОписаниеОбработкиШтрихкода.НомерНоменклатуры);

        ПоказатьВажноеОповещениеОбОшибкеДляКодаВозврата(ОписаниеОбработкиШтрихкода.КодВозврата,
                                                        "Принято больше, чем поставлено",
                                                        ПояснениеОповещения);
