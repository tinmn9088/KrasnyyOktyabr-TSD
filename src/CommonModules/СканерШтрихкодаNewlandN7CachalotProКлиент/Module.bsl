...
// 
// Параметры:
//  ВнешниеКомпоненты - См. ВнешниеКомпонентыМенеджерКлиент.НоваяКоллекцияВнешнихКомпонент
...
// 
// Параметры:
//  ОписаниеВнешнегоСобытия - См. ВнешниеКомпонентыМенеджерКлиент.НовоеОписаниеВнешнегоСобытия
Процедура ОбработатьВнешнееСобытие(ОписаниеВнешнегоСобытия) Экспорт

    Событие = ОповещенияКлиентСервер.ИмяСобытияСканированияШтрихкода();
