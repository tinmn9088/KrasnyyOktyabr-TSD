...
Функция ШтриходУжеПроведен(Знач Штрихкод) Экспорт
    ...
    Запрос = Новый Запрос("ВЫБРАТЬ
                          ...
                          |ИЗ
                          |    РегистрСведений.ПроведенныеШтрихкоды КАК ПроведенныеШтрихкоды
                          |ГДЕ
                          |    ПроведенныеШтрихкоды.Штрихкод = &Штрихкод");
...
Функция НайтиПоШтрихкоду(Знач Штрихкод) Экспорт
    ...
    Запрос.Текст = "ВЫБРАТЬ
                   |    ПроведенныеШтрихкоды.Штрихкод,
                   |    ПроведенныеШтрихкоды.Дата,
                   |    ПроведенныеШтрихкоды.Задание,
                   |    ПроведенныеШтрихкоды.НомерЗаданияНаОтбор,
                   |    ПроведенныеШтрихкоды.Комлпектовщик
                   |ИЗ
                   |    РегистрСведений.ПроведенныеШтрихкоды КАК ПроведенныеШтрихкоды
                   |ГДЕ
                   |    ПроведенныеШтрихкоды.Штрихкод = &Штрихкод";
...
Функция ПровестиШтрихкод(Знач Штрихкод, Знач Задание, Знач НомерЗаданияНаОтбор, Знач Комплектовщик) Экспорт
    ...
    Запись.Комлпектовщик = Комплектовщик;
