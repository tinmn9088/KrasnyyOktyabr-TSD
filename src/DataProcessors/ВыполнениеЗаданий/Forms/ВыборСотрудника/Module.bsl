...
Процедура ОткрытьВыборЗадания(Знач ТабельныйНомер)
    ...
    Если Не ЗначениеЗаполнено(Сотрудник) Тогда
        ...
        ОповещенияПользователяКлиент.ПоказатьОповещение("Сотрудник не найден",
                                                        ТабельныйНомер,
                                                        КлючУникальностиОповещенийПользователя());
        Возврат;
    ...
    ОткрытьФорму("Документ.Задание.Форма.ВыборЗаданияДляКомплектовщика", ПараметрыФормы);
...
Функция НайтиСотрудникаПоТабельномуНомеру(Знач ТабельныйНомер)
    ...
    Возврат МенеджерКомплектовщики.НайтиПоТабельномуНомеру(ТабельныйНомер);
