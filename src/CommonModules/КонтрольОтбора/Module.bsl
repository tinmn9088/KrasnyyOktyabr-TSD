...
Функция ОсталосьПоЗаданию(Знач Задание, Знач Комплектовщик) Экспорт
    ...
    Запрос = Новый Запрос("ВЫБРАТЬ
                          ...
                          |ИЗ
                          |    ЗаданияНаОтбор КАК ЗаданияНаОтбор
                          |        ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Модели КАК Модели
                          |        ПО ЗаданияНаОтбор.Модель = Модели.Ссылка
                          |;
                          |
                          |////////////////////////////////////////////////////////////////////////////////
                          |ВЫБРАТЬ
...
Функция ПровестиШтрихкод(Знач Штрихкод,
    ...
    Если РегистрыСведений.ПроведенныеШтрихкодыКонтроляОтбора.ПровестиШтрихкод(Штрихкод,
                                                                              Задание,
                                                                              НомерЗаданияНаОтбор,
                                                                              Комплектовщик) Тогда
    ...
    Иначе
        ...
        ОписаниеПроведенияШтрихкода = РегистрыСведений.ПроведенныеШтрихкодыКонтроляОтбора.НайтиПоШтрихкоду(Штрихкод);
...
Процедура ЗаписатьОшибкуПроведенияШтрихкода(Знач КодВозврата, Знач Штрихкод, Знач Задание, Знач Комплектовщик)
    ...
    Тип = КонтрольОтбораКлиентСервер.ТипШтрихкода(Штрихкод);
