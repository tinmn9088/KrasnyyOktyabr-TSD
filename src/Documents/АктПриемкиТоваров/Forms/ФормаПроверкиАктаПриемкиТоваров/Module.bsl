...
Процедура ЗакончитьПроверкуЭлектроннойНакладной(Команда)
    ...
    ОповещенияПользователяКлиент.ПоказатьВажноеОповещениеОшибка("Не удалось завершить проверку эл. накл.",
                                                                "Необходимо расширение для обмена с ЭДиН",
...
Процедура ПоказатьПроверкаЗавершена()
    ...
    Элементы.КнопкаЗакончитьПроверкуЭлектроннойНакладной.Видимость = Ложь;
