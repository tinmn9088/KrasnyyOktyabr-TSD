...
//  НомерТовара - Число
&НаСервереБезКонтекста
Процедура УдалитьТовар(Знач ПеремещениеТоваров, Знач НомерТовара)

    ПеремещениеТоваров.ПолучитьОбъект().УдалитьТовар(НомерТовара);
...
//  Строка 
&НаСервереБезКонтекста
Функция КодНоменклатурыЧерезНомерТовара(Знач ПеремещениеТоваров, Знач НомерТовара)
